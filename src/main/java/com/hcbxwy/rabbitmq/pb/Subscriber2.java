...
public class Subscriber2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueDeclare(Publisher.FANOUT_QUEUE_2, true, false, false, null);
        channel.queueBind(Publisher.FANOUT_QUEUE_2, Publisher.FANOUT_EXCHANGE, "");
        ...
        DefaultConsumer consumer = new DefaultConsumer(channel){
            ...
            public void handleDelivery(String consumerTag, Envelope envelope, AMQP.BasicProperties properties, byte[] body) {
                ...
                System.err.println("订阅者2收到的消息：" + new String(body, StandardCharsets.UTF_8));
            }
        };
         ...
         * 参数1：消息收到后回调
         */
        channel.basicConsume(Publisher.FANOUT_QUEUE_2, true, consumer);
    }
}
